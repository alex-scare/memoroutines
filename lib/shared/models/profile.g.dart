...
extension ProfileQueryLinks
    on QueryBuilder<Profile, Profile, QFilterCondition> {
  QueryBuilder<Profile, Profile, QAfterFilterCondition> routines(
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> routinesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> routinesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'routines', 0, true, 0, true);
    });
  }

  QueryBuilder<Profile, Profile, QAfterFilterCondition> routinesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'routines', 0, false, 999999, true);
    });
  }

  QueryBuilder<Profile, Profile, QAfterFilterCondition> routinesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> routinesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
